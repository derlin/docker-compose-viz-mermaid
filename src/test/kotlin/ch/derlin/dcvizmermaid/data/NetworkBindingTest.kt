...
class NetworkBindingTest {
    companion object {
        ...
        private fun parseNetwork(src: String) = NetworkBinding.parse(SERVICE_NAME, YamlUtils.load(src).getListOrMapByPath("networks"))

        private fun assertNetworkBindingsEqual(
            yaml: String,
            expected: List<NetworkBinding>,
        ) {
